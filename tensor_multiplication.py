...
def calculate_activation(sum_total):
    ...
    """
    return torch.heaviside(sum_total, torch.zeros_like(sum_total))
...
def calculate_output(X, W, b):
    ...
    """
    matrix_prod_with_bias = calculate_matrix_prod_with_bias(X, W, b)
    return calculate_activation(matrix_prod_with_bias)